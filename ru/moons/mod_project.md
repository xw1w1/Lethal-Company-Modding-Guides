...
Он бывает разных типов: от собственных предметов и лун до собственного транспорта и типа отпечатков на земле.
...
Я делаю это так, но вы можете организовать проект так, как будет удобно лично вам. Я просто показываю, как распределены ресурсы у меня.

После организации всего необходимого, вы можете приступить к следующему шагу: https://github.com/xw1w1/Lethal-Company-Modding-Guides/blob/main/ru/moons/moon_setup.md
